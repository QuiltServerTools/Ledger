...
private fun onItemPickUp(
    ...
    DatabaseManager.logAction(ActionFactory.itemPickUpAction(world, pos, stack, player))
}
...
private fun onItemDrop(
    ...
    DatabaseManager.logAction(ActionFactory.itemDropAction(world, pos, stack, player))
}
