...
data class PlayerResult(val uuid: UUID, val name: String, val firstJoin: Instant, val lastJoin: Instant) {
    ...
    fun toText(): Text {
        return Text.translatable(
            ...
            MessageUtils.instantTimeToDiffText(firstJoin).setStyle(TextColorPallet.primaryVariant),
            MessageUtils.instantTimeToDiffText(lastJoin).setStyle(TextColorPallet.primaryVariant)
